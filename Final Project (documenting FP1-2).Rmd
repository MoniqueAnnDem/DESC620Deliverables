---
title: "Final Project (documenting FP1-2)"
...
#This code outputs a dataframe with 8 ticker symbols, "EBAY"  "PHM"   "KMI"   "LBTYA" "MNTA"  "OLED"  "LNN"  "TSLA". It should be 9 and include IBM, but IBM's ticker symbol is not tagged in the same manner in the webpage HTML code.

#df_ticker is the data frame showing the output table
